...
public class Messages {
  ...
  public static class CreateEngineRequest {
    ...
    private Boolean videoAdapt;
    public Boolean getVideoAdapt() { return videoAdapt; }
    public void setVideoAdapt(Boolean setterArg) { this.videoAdapt = setterArg; }
    ...
    public Long getChannelProfile() { return channelProfile; }
    public void setChannelProfile(Long setterArg) { this.channelProfile = setterArg; }
    ...
    HashMap toMap() {
      ...
      toMapResult.put("videoAdapt", videoAdapt);
      ...
      toMapResult.put("channelProfile", channelProfile);
      return toMapResult;
    }
    static CreateEngineRequest fromMap(HashMap map) {
      ...
      Object videoAdapt = map.get("videoAdapt");
      fromMapResult.videoAdapt = (Boolean)videoAdapt;
      ...
      fromMapResult.channelProfile = (channelProfile == null) ? null : ((channelProfile instanceof Integer) ? (Integer)channelProfile : (Long)channelProfile);
      return fromMapResult;
    }
  }
