...
class AddOrUpdateLiveStreamTaskRequest {
  ...
  // ignore: unused_element
  static AddOrUpdateLiveStreamTaskRequest _fromMap(Map<dynamic, dynamic> pigeonMap) {
    final AddOrUpdateLiveStreamTaskRequest result = AddOrUpdateLiveStreamTaskRequest();
    result.serial = pigeonMap['serial'];
    result.taskId = pigeonMap['taskId'];
    result.url = pigeonMap['url'];
    result.serverRecordEnabled = pigeonMap['serverRecordEnabled'];
    result.liveMode = pigeonMap['liveMode'];
    result.layoutWidth = pigeonMap['layoutWidth'];
    result.layoutHeight = pigeonMap['layoutHeight'];
    result.layoutBackgroundColor = pigeonMap['layoutBackgroundColor'];
    result.layoutImageUrl = pigeonMap['layoutImageUrl'];
    result.layoutImageX = pigeonMap['layoutImageX'];
    result.layoutImageY = pigeonMap['layoutImageY'];
    result.layoutImageWidth = pigeonMap['layoutImageWidth'];
    result.layoutImageHeight = pigeonMap['layoutImageHeight'];
    result.layoutUserTranscodingList = pigeonMap['layoutUserTranscodingList'];
    return result;
  }
}
...
class DeleteLiveStreamTaskRequest {
  ...
  // ignore: unused_element
  static DeleteLiveStreamTaskRequest _fromMap(Map<dynamic, dynamic> pigeonMap) {
    final DeleteLiveStreamTaskRequest result = DeleteLiveStreamTaskRequest();
    result.serial = pigeonMap['serial'];
    result.taskId = pigeonMap['taskId'];
    return result;
  }
...
class EngineApi {
  ...
  Future<IntValue> addLiveStreamTask(AddOrUpdateLiveStreamTaskRequest arg) async {
    final Map<dynamic, dynamic> requestMap = arg._toMap();
    const BasicMessageChannel<dynamic> channel =
        BasicMessageChannel<dynamic>('dev.flutter.pigeon.EngineApi.addLiveStreamTask', StandardMessageCodec());
  ...
  Future<IntValue> updateLiveStreamTask(AddOrUpdateLiveStreamTaskRequest arg) async {
    final Map<dynamic, dynamic> requestMap = arg._toMap();
    const BasicMessageChannel<dynamic> channel =
        BasicMessageChannel<dynamic>('dev.flutter.pigeon.EngineApi.updateLiveStreamTask', StandardMessageCodec());
  ...
  Future<IntValue> removeLiveStreamTask(DeleteLiveStreamTaskRequest arg) async {
    final Map<dynamic, dynamic> requestMap = arg._toMap();
    const BasicMessageChannel<dynamic> channel =
        BasicMessageChannel<dynamic>('dev.flutter.pigeon.EngineApi.removeLiveStreamTask', StandardMessageCodec());
