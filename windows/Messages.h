...
template<class T> class ErrorOr {
 ...
 private:
  friend class NERtcAudioFrameEventSink;
  friend class NERtcSubChannelEventSink;
...
class NERtcUserJoinExtraInfo {
 ...
 private:
  ...
  friend class NERtcAudioFrameEventSink;
  friend class NERtcAudioFrameEventSinkCodecSerializer;
  friend class NERtcSubChannelEventSink;
  friend class NERtcSubChannelEventSinkCodecSerializer;
  friend class NERtcChannelEventSink;
  friend class NERtcChannelEventSinkCodecSerializer;
  friend class ChannelApi;
  friend class ChannelApiCodecSerializer;
  friend class EngineApi;
...
class FirstVideoDataReceivedEvent {
 public:
  ...
  // Constructs an object setting all fields.
  explicit FirstVideoDataReceivedEvent(
    int64_t uid,
    const int64_t* stream_type);
...
class FirstVideoFrameDecodedEvent {
 public:
  // Constructs an object setting all non-nullable fields.
  explicit FirstVideoFrameDecodedEvent(
    int64_t uid,
    int64_t width,
    int64_t height);
...
class VirtualBackgroundSourceEnabledEvent {
 public:
  // Constructs an object setting all fields.
  explicit VirtualBackgroundSourceEnabledEvent(
    bool enabled,
    int64_t reason);
...
// Generated class from Pigeon that represents data sent in messages.
class NERtcAudioFrameFormat {
 public:
  // Constructs an object setting all fields.
  explicit NERtcAudioFrameFormat(
    int64_t type,
    int64_t channels,
    int64_t sample_rate,
  ...
  int64_t bytes_per_sample() const;
  void set_bytes_per_sample(int64_t value_arg);

  int64_t samples_per_channel() const;
  void set_samples_per_channel(int64_t value_arg);


 private:
  static NERtcAudioFrameFormat FromEncodableList(const flutter::EncodableList& list);
  flutter::EncodableList ToEncodableList() const;
  friend class NERtcAudioFrame;
  friend class NERtcAudioFrameEventSink;
  friend class NERtcAudioFrameEventSinkCodecSerializer;
  friend class NERtcSubChannelEventSink;
  friend class NERtcSubChannelEventSinkCodecSerializer;
...
class NERtcAudioFrameRequestFormat {
 public:
  ...
  // Constructs an object setting all fields.
  explicit NERtcAudioFrameRequestFormat(
  ...
  const int64_t* op_mode() const;
  void set_op_mode(const int64_t* value_arg);
  void set_op_mode(int64_t value_arg);


 private:
  static NERtcAudioFrameRequestFormat FromEncodableList(const flutter::EncodableList& list);
  flutter::EncodableList ToEncodableList() const;
  friend class NERtcAudioFrameEventSink;
  friend class NERtcAudioFrameEventSinkCodecSerializer;
  friend class NERtcSubChannelEventSink;
...
class NERtcAudioFrame {
 public:
  ...
  // Constructs an object setting all fields.
  explicit NERtcAudioFrame(
    const NERtcAudioFrameFormat* format,
    const std::vector<uint8_t>* data);

  const NERtcAudioFrameFormat* format() const;
  void set_format(const NERtcAudioFrameFormat* value_arg);
  void set_format(const NERtcAudioFrameFormat& value_arg);
 ...
 private:
  static NERtcAudioFrame FromEncodableList(const flutter::EncodableList& list);
  flutter::EncodableList ToEncodableList() const;
  friend class NERtcAudioFrameEventSink;
  friend class NERtcAudioFrameEventSinkCodecSerializer;
  friend class NERtcSubChannelEventSink;
  ...
  friend class NERtcLiveStreamEventSink;
  friend class NERtcLiveStreamEventSinkCodecSerializer;
  std::optional<NERtcAudioFrameFormat> format_;
...
class RemoteAudioVolumeIndicationEvent {
 public:
  ...
  // Constructs an object setting all fields.
  explicit RemoteAudioVolumeIndicationEvent(
    const flutter::EncodableList* volume_list,
...
class NERtcLastmileProbeResult {
 public:
  // Constructs an object setting all fields.
  explicit NERtcLastmileProbeResult(
    int64_t state,
    int64_t rtt,
...
class NERtcLastmileProbeOneWayResult {
 public:
  // Constructs an object setting all fields.
  explicit NERtcLastmileProbeOneWayResult(
...
class CreateEngineRequest {
 public:
  ...
  const bool* audio_frame_callback_enabled() const;
  void set_audio_frame_callback_enabled(const bool* value_arg);
  void set_audio_frame_callback_enabled(bool value_arg);
 ...
 private:
  ...
  std::optional<bool> audio_frame_callback_enabled_;
...
class SubscribeRemoteAudioRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit SubscribeRemoteAudioRequest(
    const int64_t* uid,
...
class EnableLocalVideoRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit EnableLocalVideoRequest(
    const bool* enable,
    const int64_t* stream_type);
...
class SetAudioProfileRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit SetAudioProfileRequest(
...
class SetLocalVideoConfigRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit SetLocalVideoConfigRequest(
...
class SetCameraCaptureConfigRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit SetCameraCaptureConfigRequest(
...
class StartScreenCaptureRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit StartScreenCaptureRequest(
...
class SubscribeRemoteVideoStreamRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit SubscribeRemoteVideoStreamRequest(
    const int64_t* uid,
    const int64_t* stream_type,
    const bool* subscribe);
...
class SubscribeRemoteSubStreamVideoRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit SubscribeRemoteSubStreamVideoRequest(
    const int64_t* uid,
    const bool* subscribe);
...
class EnableAudioVolumeIndicationRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit EnableAudioVolumeIndicationRequest(
    const bool* enable,
...
class SubscribeRemoteSubStreamAudioRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit SubscribeRemoteSubStreamAudioRequest(
    const bool* subscribe,
    const int64_t* uid);
...
class StartAudioMixingRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit StartAudioMixingRequest(
...
class SetCameraPositionRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit SetCameraPositionRequest(
    const double* x,
    const double* y);
...
class DeleteLiveStreamTaskRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit DeleteLiveStreamTaskRequest(
    const int64_t* serial,
    const std::string* task_id);
...
class SetLocalVoiceEqualizationRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit SetLocalVoiceEqualizationRequest(
...
class StartAudioRecordingRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit StartAudioRecordingRequest(
...
class AudioRecordingConfigurationRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit AudioRecordingConfigurationRequest(
    const std::string* file_path,
    const int64_t* sample_rate,
    const int64_t* quality,
...
class SetLocalMediaPriorityRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit SetLocalMediaPriorityRequest(
...
class StartOrUpdateChannelMediaRelayRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit StartOrUpdateChannelMediaRelayRequest(
    const flutter::EncodableMap* source_media_info,
 ...
 private:
  static StartOrUpdateChannelMediaRelayRequest FromEncodableList(const flutter::EncodableList& list);
  flutter::EncodableList ToEncodableList() const;
  friend class NERtcAudioFrameEventSink;
  friend class NERtcAudioFrameEventSinkCodecSerializer;
  friend class NERtcSubChannelEventSink;
...
class AdjustUserPlaybackSignalVolumeRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit AdjustUserPlaybackSignalVolumeRequest(
    const int64_t* uid,
 ...
 private:
  static AdjustUserPlaybackSignalVolumeRequest FromEncodableList(const flutter::EncodableList& list);
  flutter::EncodableList ToEncodableList() const;
  friend class NERtcAudioFrameEventSink;
  friend class NERtcAudioFrameEventSinkCodecSerializer;
  friend class NERtcSubChannelEventSink;
...
class EnableEncryptionRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit EnableEncryptionRequest(
...
class SetLocalVoiceReverbParamRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit SetLocalVoiceReverbParamRequest(
...
class ReportCustomEventRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit ReportCustomEventRequest(
...
class StartLastmileProbeTestRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit StartLastmileProbeTestRequest(
...
class SetVideoCorrectionConfigRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit SetVideoCorrectionConfigRequest(
...
class EnableVirtualBackgroundRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit EnableVirtualBackgroundRequest(
    const bool* enabled,
...
class SetRemoteHighPriorityAudioStreamRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit SetRemoteHighPriorityAudioStreamRequest(
    const bool* enabled,
    const int64_t* uid,
    const int64_t* stream_type);
 ...
 private:
  static SetRemoteHighPriorityAudioStreamRequest FromEncodableList(const flutter::EncodableList& list);
  flutter::EncodableList ToEncodableList() const;
  friend class NERtcAudioFrameEventSink;
  friend class NERtcAudioFrameEventSinkCodecSerializer;
  friend class NERtcSubChannelEventSink;
...
class VideoWatermarkTextConfig {
 public:
  ...
  // Constructs an object setting all fields.
  explicit VideoWatermarkTextConfig(
    const double* wm_alpha,
    const int64_t* wm_width,
    const int64_t* wm_height,
    const int64_t* offset_x,
...
class VideoWatermarkTimestampConfig {
 public:
  ...
  // Constructs an object setting all fields.
  explicit VideoWatermarkTimestampConfig(
    const double* wm_alpha,
    const int64_t* wm_width,
    const int64_t* wm_height,
    const int64_t* offset_x,
...
class SetLocalVideoWatermarkConfigsRequest {
 public:
  ...
  // Constructs an object setting all fields.
  explicit SetLocalVideoWatermarkConfigsRequest(
    int64_t type,
...
class NERtcAudioFrameEventSinkCodecSerializer : public flutter::StandardCodecSerializer {
 public:
  NERtcAudioFrameEventSinkCodecSerializer();
  inline static NERtcAudioFrameEventSinkCodecSerializer& GetInstance() {
    static NERtcAudioFrameEventSinkCodecSerializer sInstance;
    return sInstance;
  }
...
class NERtcAudioFrameEventSink {
 public:
  NERtcAudioFrameEventSink(flutter::BinaryMessenger* binary_messenger);
  static const flutter::StandardMessageCodec& GetCodec();
  void OnRecordFrame(
    const NERtcAudioFrame& frame,
    std::function<void(void)>&& on_success,
    std::function<void(const FlutterError&)>&& on_error);
  void OnPlaybackFrame(
    const NERtcAudioFrame& frame,
    std::function<void(void)>&& on_success,
    std::function<void(const FlutterError&)>&& on_error);
...
class NERtcSubChannelEventSinkCodecSerializer : public flutter::StandardCodecSerializer {
 public:
  NERtcSubChannelEventSinkCodecSerializer();
  inline static NERtcSubChannelEventSinkCodecSerializer& GetInstance() {
    static NERtcSubChannelEventSinkCodecSerializer sInstance;
    return sInstance;
  }
...
class NERtcSubChannelEventSink {
 public:
  NERtcSubChannelEventSink(flutter::BinaryMessenger* binary_messenger);
  static const flutter::StandardMessageCodec& GetCodec();
  void OnJoinChannel(
  ...
  void OnUserAudioStart(
    ...
    std::function<void(void)>&& on_success,
    std::function<void(const FlutterError&)>&& on_error);
  void OnUserSubStreamAudioStart(
    const std::string& channel_tag,
    int64_t uid,
    std::function<void(void)>&& on_success,
    std::function<void(const FlutterError&)>&& on_error);
  ...
  void OnUserVideoMute(
    const std::string& channel_tag,
    const UserVideoMuteEvent& event,
    std::function<void(void)>&& on_success,
    std::function<void(const FlutterError&)>&& on_error);
  ...
  void OnFirstVideoDataReceived(
    const std::string& channel_tag,
    const FirstVideoDataReceivedEvent& event,
    std::function<void(void)>&& on_success,
    std::function<void(const FlutterError&)>&& on_error);
  ...
  void OnFirstVideoFrameDecoded(
    const std::string& channel_tag,
    const FirstVideoFrameDecodedEvent& event,
    std::function<void(void)>&& on_success,
    std::function<void(const FlutterError&)>&& on_error);
  void OnVirtualBackgroundSourceEnabled(
    const std::string& channel_tag,
    const VirtualBackgroundSourceEnabledEvent& event,
    std::function<void(void)>&& on_success,
    std::function<void(const FlutterError&)>&& on_error);
  void OnConnectionTypeChanged(
    const std::string& channel_tag,
    int64_t new_connection_type,
    std::function<void(void)>&& on_success,
    std::function<void(const FlutterError&)>&& on_error);
  ...
  void OnRemoteAudioVolumeIndication(
    const std::string& channel_tag,
    const RemoteAudioVolumeIndicationEvent& event,
    std::function<void(void)>&& on_success,
    std::function<void(const FlutterError&)>&& on_error);
  ...
  void OnMediaRightChange(
    const std::string& channel_tag,
    bool is_audio_banned_by_server,
    bool is_video_banned_by_server,
    std::function<void(void)>&& on_success,
    std::function<void(const FlutterError&)>&& on_error);
...
class ChannelApiCodecSerializer : public flutter::StandardCodecSerializer {
 public:
  ChannelApiCodecSerializer();
  inline static ChannelApiCodecSerializer& GetInstance() {
    static ChannelApiCodecSerializer sInstance;
    return sInstance;
  }
...
class ChannelApi {
 public:
  ChannelApi(const ChannelApi&) = delete;
  ChannelApi& operator=(const ChannelApi&) = delete;
  virtual ~ChannelApi() {}
  virtual ErrorOr<std::string> GetChannelName(const std::string& channel_tag) = 0;
  virtual ErrorOr<int64_t> SetStatsEventCallback(const std::string& channel_tag) = 0;
  virtual ErrorOr<int64_t> ClearStatsEventCallback(const std::string& channel_tag) = 0;
  virtual ErrorOr<int64_t> SetChannelProfile(
    const std::string& channel_tag,
    int64_t channel_profile) = 0;
  virtual ErrorOr<int64_t> EnableMediaPub(
    const std::string& channel_tag,
    int64_t media_type,
    bool enable) = 0;
  virtual ErrorOr<int64_t> JoinChannel(
    const std::string& channel_tag,
    const JoinChannelRequest& request) = 0;
  virtual ErrorOr<int64_t> LeaveChannel(const std::string& channel_tag) = 0;
  virtual ErrorOr<int64_t> SetClientRole(
    const std::string& channel_tag,
    int64_t role) = 0;
  virtual ErrorOr<int64_t> GetConnectionState(const std::string& channel_tag) = 0;
  virtual ErrorOr<int64_t> Release(const std::string& channel_tag) = 0;
  virtual ErrorOr<int64_t> EnableLocalAudio(
    const std::string& channel_tag,
    bool enable) = 0;
  virtual ErrorOr<int64_t> MuteLocalAudioStream(
    const std::string& channel_tag,
    bool mute) = 0;
  virtual ErrorOr<int64_t> SubscribeRemoteAudio(
    const std::string& channel_tag,
    int64_t uid,
    bool subscribe) = 0;
  virtual ErrorOr<int64_t> SubscribeRemoteSubAudio(
    const std::string& channel_tag,
    int64_t uid,
    bool subscribe) = 0;
  virtual ErrorOr<int64_t> SetLocalVideoConfig(
    const std::string& channel_tag,
    const SetLocalVideoConfigRequest& request) = 0;
  virtual ErrorOr<int64_t> EnableLocalVideo(
    const std::string& channel_tag,
    const EnableLocalVideoRequest& request) = 0;
  virtual ErrorOr<int64_t> MuteLocalVideoStream(
    const std::string& channel_tag,
    bool mute,
    int64_t stream_type) = 0;
  virtual ErrorOr<int64_t> SwitchCamera(const std::string& channel_tag) = 0;
  virtual ErrorOr<int64_t> SubscribeRemoteVideoStream(
    const std::string& channel_tag,
    const SubscribeRemoteVideoStreamRequest& request) = 0;
  virtual ErrorOr<int64_t> SubscribeRemoteSubVideoStream(
    const std::string& channel_tag,
    int64_t uid,
    bool subscribe) = 0;
  ...
  virtual ErrorOr<int64_t> TakeLocalSnapshot(
    const std::string& channel_tag,
    int64_t stream_type,
    const std::string& path) = 0;
  virtual ErrorOr<int64_t> TakeRemoteSnapshot(
    const std::string& channel_tag,
    int64_t uid,
    int64_t stream_type,
    const std::string& path) = 0;
...
class EngineApi {
 public:
  ...
  virtual ErrorOr<int64_t> SetRecordingAudioFrameParameters(const NERtcAudioFrameRequestFormat& request) = 0;
  virtual ErrorOr<int64_t> SetPlaybackAudioFrameParameters(const NERtcAudioFrameRequestFormat& request) = 0;
  virtual ErrorOr<int64_t> SetPlaybackBeforeMixingAudioFrameParameters(const NERtcAudioFrameRequestFormat& request) = 0;
  virtual ErrorOr<int64_t> SetMixedAudioFrameParameters(const NERtcAudioFrameRequestFormat& request) = 0;
  virtual ErrorOr<int64_t> CreateChannel(const std::string& channel_tag) = 0;
  ...
  virtual ErrorOr<int64_t> SetVideoRotationMode(int64_t rotation_mode) = 0;
  ...
  virtual ErrorOr<int64_t> SubscribeRemoteSubStreamAudio(const SubscribeRemoteSubStreamAudioRequest& request) = 0;
  virtual ErrorOr<int64_t> MuteLocalSubStreamAudio(bool muted) = 0;
  virtual ErrorOr<int64_t> SetAudioSubscribeOnlyBy(const SetAudioSubscribeOnlyByRequest& request) = 0;
  virtual void StartScreenCapture(
    const StartScreenCaptureRequest& request,
  ...
  virtual ErrorOr<int64_t> SubscribeRemoteVideoStream(const SubscribeRemoteVideoStreamRequest& request) = 0;
  virtual ErrorOr<int64_t> SubscribeRemoteSubStreamVideo(const SubscribeRemoteSubStreamVideoRequest& request) = 0;
  ...
  virtual ErrorOr<int64_t> EnableAudioVolumeIndication(const EnableAudioVolumeIndicationRequest& request) = 0;
  ...
  virtual ErrorOr<int64_t> UpdateLiveStreamTask(const AddOrUpdateLiveStreamTaskRequest& request) = 0;
  ...
  virtual ErrorOr<int64_t> SetLocalVoiceReverbParam(const SetLocalVoiceReverbParamRequest& request) = 0;
  ...
  virtual ErrorOr<int64_t> SetLocalVoiceEqualization(const SetLocalVoiceEqualizationRequest& request) = 0;
  ...
  virtual ErrorOr<int64_t> StartAudioRecordingWithConfig(const AudioRecordingConfigurationRequest& request) = 0;
  ...
  virtual ErrorOr<int64_t> EnableMediaPub(
    int64_t media_type,
    bool enable) = 0;
  virtual ErrorOr<int64_t> StartChannelMediaRelay(const StartOrUpdateChannelMediaRelayRequest& request) = 0;
  virtual ErrorOr<int64_t> UpdateChannelMediaRelay(const StartOrUpdateChannelMediaRelayRequest& request) = 0;
  virtual ErrorOr<int64_t> StopChannelMediaRelay() = 0;
  virtual ErrorOr<int64_t> AdjustUserPlaybackSignalVolume(const AdjustUserPlaybackSignalVolumeRequest& request) = 0;
  ...
  virtual ErrorOr<int64_t> SetVideoCorrectionConfig(const SetVideoCorrectionConfigRequest& request) = 0;
  virtual ErrorOr<int64_t> EnableVirtualBackground(const EnableVirtualBackgroundRequest& request) = 0;
  virtual ErrorOr<int64_t> SetRemoteHighPriorityAudioStream(const SetRemoteHighPriorityAudioStreamRequest& request) = 0;
  ...
  virtual ErrorOr<int64_t> SetBeautyEffect(
    double level,
    int64_t beauty_type) = 0;
  virtual ErrorOr<int64_t> AddBeautyFilter(
    const std::string& path,
    const std::string& name) = 0;
  virtual std::optional<FlutterError> RemoveBeautyFilter() = 0;
  virtual ErrorOr<int64_t> SetBeautyFilterLevel(double level) = 0;
  virtual ErrorOr<int64_t> SetLocalVideoWatermarkConfigs(const SetLocalVideoWatermarkConfigsRequest& request) = 0;
  ...
  virtual ErrorOr<int64_t> TakeRemoteSnapshot(
    ...
    int64_t stream_type,
    const std::string& path) = 0;
  virtual ErrorOr<int64_t> SetExternalVideoSource(
    int64_t stream_type,
    bool enable) = 0;
  virtual ErrorOr<int64_t> PushExternalVideoFrame(
    int64_t stream_type,
...
class VideoRendererApi {
 public:
  ...
  virtual ErrorOr<int64_t> SetMirror(
    int64_t texture_id,
    bool mirror) = 0;
  virtual ErrorOr<int64_t> SetupLocalVideoRenderer(
    int64_t texture_id,
    const std::string& channel_tag) = 0;
  virtual ErrorOr<int64_t> SetupRemoteVideoRenderer(
    int64_t uid,
    int64_t texture_id,
    const std::string& channel_tag) = 0;
  virtual ErrorOr<int64_t> SetupLocalSubStreamVideoRenderer(
    int64_t texture_id,
    const std::string& channel_tag) = 0;
  virtual ErrorOr<int64_t> SetupRemoteSubStreamVideoRenderer(
    int64_t uid,
    int64_t texture_id,
    const std::string& channel_tag) = 0;
...
class NERtcDeviceEventSink {
 public:
  ...
  void OnAudioDeviceStateChange(
    ...
    std::function<void(void)>&& on_success,
    std::function<void(const FlutterError&)>&& on_error);
  void OnVideoDeviceStateChange(
    int64_t device_type,
    int64_t device_state,
    std::function<void(void)>&& on_success,
    std::function<void(const FlutterError&)>&& on_error);
  void OnCameraFocusChanged(
    const CGPoint& focus_point,
    std::function<void(void)>&& on_success,
    std::function<void(const FlutterError&)>&& on_error);
  void OnCameraExposureChanged(
    const CGPoint& exposure_point,
    std::function<void(void)>&& on_success,
    std::function<void(const FlutterError&)>&& on_error);
...
class DeviceManagerApi {
 public:
  ...
  virtual ErrorOr<int64_t> EnableEarback(
    bool enabled,
    int64_t volume) = 0;
...
class AudioEffectApi {
 public:
  ...
  virtual ErrorOr<int64_t> SetEffectSendVolume(
    int64_t effect_id,
    int64_t volume) = 0;
  virtual ErrorOr<int64_t> GetEffectSendVolume(int64_t effect_id) = 0;
  virtual ErrorOr<int64_t> SetEffectPlaybackVolume(
    int64_t effect_id,
    int64_t volume) = 0;
  ...
  virtual ErrorOr<int64_t> SetEffectPitch(
    int64_t effect_id,
    int64_t pitch) = 0;
  virtual ErrorOr<int64_t> GetEffectPitch(int64_t effect_id) = 0;
  virtual ErrorOr<int64_t> SetEffectPosition(
    int64_t effect_id,
    int64_t position) = 0;
...
class NERtcAudioEffectEventSink {
 public:
  ...
  void OnAudioEffectFinished(
    ...
    std::function<void(void)>&& on_success,
    std::function<void(const FlutterError&)>&& on_error);
  void OnAudioEffectTimestampUpdate(
    int64_t id,
    int64_t timestamp_ms,
    std::function<void(void)>&& on_success,
    std::function<void(const FlutterError&)>&& on_error);
...
class NERtcLiveStreamEventSink {
 public:
  ...
  void OnUpdateLiveStreamTask(
    ...
    std::function<void(void)>&& on_success,
    std::function<void(const FlutterError&)>&& on_error);
  void OnAddLiveStreamTask(
    const std::string& task_id,
    int64_t err_code,
    std::function<void(void)>&& on_success,
    std::function<void(const FlutterError&)>&& on_error);
  void OnDeleteLiveStreamTask(
    const std::string& task_id,
    int64_t err_code,
    std::function<void(void)>&& on_success,
    std::function<void(const FlutterError&)>&& on_error);
