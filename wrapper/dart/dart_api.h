 ...
 *   parameters.
 */
DART_EXPORT Dart_FinalizableHandle Dart_NewFinalizableHandle(
    Dart_Handle object, void* peer, intptr_t external_allocation_size,
    Dart_HandleFinalizer callback);
...
typedef Dart_Isolate (*Dart_IsolateGroupCreateCallback)(
    const char* script_uri, const char* main, const char* package_root,
    const char* package_config, Dart_IsolateFlags* flags, void* isolate_data,
    char** error);
 ...
 */
typedef void (*Dart_FileReadCallback)(uint8_t** data, intptr_t* file_length,
                                      void* stream);
 ...
 * \param stream Handle to the opened file.
 */
typedef void (*Dart_FileWriteCallback)(const void* data, intptr_t length,
                                       void* stream);
...
typedef struct {
  ...
  /**
   * Kernel blob registration callback function. See
   * Dart_RegisterKernelBlobCallback.
   */
  Dart_RegisterKernelBlobCallback register_kernel_blob;

  /**
   * Kernel blob unregistration callback function. See
...
DART_EXPORT Dart_Isolate Dart_CreateIsolateGroup(
    const char* script_uri, const char* name,
...
Dart_CreateIsolateInGroup(Dart_Isolate group_member, const char* name,
...
DART_EXPORT Dart_Isolate Dart_CreateIsolateGroupFromKernel(
    const char* script_uri, const char* name, const uint8_t* kernel_buffer,
    intptr_t kernel_buffer_size, Dart_IsolateFlags* flags,
    void* isolate_group_data, void* isolate_data, char** error);
/**
 ...
 */
DART_EXPORT void Dart_AddSymbols(const char* dso_name, void* buffer,
 ...
 */
DART_EXPORT DART_WARN_UNUSED_RESULT Dart_Handle Dart_CreateSnapshot(
    uint8_t** vm_snapshot_data_buffer, intptr_t* vm_snapshot_data_size,
    uint8_t** isolate_snapshot_data_buffer,
    intptr_t* isolate_snapshot_data_size, bool is_core);
...
DART_EXPORT DART_WARN_UNUSED_RESULT bool Dart_RunLoopAsync(
    bool errors_are_fatal, Dart_Port on_error_port, Dart_Port on_exit_port,
    char** error);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
DART_EXPORT Dart_Handle Dart_ObjectIsType(Dart_Handle object, Dart_Handle type,
                                          bool* instanceof);
...
DART_EXPORT Dart_Handle Dart_NewExternalLatin1String(
    const uint8_t* latin1_array, intptr_t length, void* peer,
 ...
 *   an error handle.
 */
DART_EXPORT Dart_Handle Dart_NewExternalUTF16String(
    const uint16_t* utf16_array, intptr_t length, void* peer,
    intptr_t external_allocation_size, Dart_HandleFinalizer callback);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
DART_EXPORT Dart_Handle Dart_StringToUTF8(Dart_Handle str, uint8_t** utf8_array,
                                          intptr_t* length);
 ...
 */
DART_EXPORT Dart_Handle Dart_ListGetRange(Dart_Handle list, intptr_t offset,
                                          intptr_t length, Dart_Handle* result);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
DART_EXPORT Dart_Handle Dart_ListSetAt(Dart_Handle list, intptr_t index,
                                       Dart_Handle value);
...
DART_EXPORT Dart_Handle Dart_NewExternalTypedDataWithFinalizer(
    Dart_TypedData_Type type, void* data, intptr_t length, void* peer,
    intptr_t external_allocation_size, Dart_HandleFinalizer callback);
 ...
 */
DART_EXPORT DART_WARN_UNUSED_RESULT Dart_Handle
Dart_New(Dart_Handle type, Dart_Handle constructor_name,
 ...
 */
DART_EXPORT Dart_Handle
Dart_AllocateWithNativeFields(Dart_Handle type, intptr_t num_native_fields,
 ...
 */
DART_EXPORT DART_WARN_UNUSED_RESULT Dart_Handle
Dart_Invoke(Dart_Handle target, Dart_Handle name, int number_of_arguments,
 ...
 */
DART_EXPORT DART_WARN_UNUSED_RESULT Dart_Handle Dart_InvokeClosure(
    Dart_Handle closure, int number_of_arguments, Dart_Handle* arguments);
 ...
 */
DART_EXPORT DART_WARN_UNUSED_RESULT Dart_Handle
Dart_InvokeConstructor(Dart_Handle object, Dart_Handle name,
                       int number_of_arguments, Dart_Handle* arguments);
 ...
 */
DART_EXPORT Dart_Handle Dart_GetNativeInstanceField(Dart_Handle obj, int index,
                                                    intptr_t* value);
 ...
 * TODO(turnidge): Document.
 */
DART_EXPORT Dart_Handle Dart_SetNativeInstanceField(Dart_Handle obj, int index,
                                                    intptr_t value);
 ...
 */
DART_EXPORT Dart_Handle
Dart_GetNativeArguments(Dart_NativeArguments args, int num_arguments,
 ...
 */
DART_EXPORT Dart_Handle
Dart_GetNativeFieldsOfArgument(Dart_NativeArguments args, int arg_index,
 ...
 */
DART_EXPORT Dart_Handle
Dart_SetNativeResolver(Dart_Handle library, Dart_NativeEntryResolver resolver,
...
typedef Dart_Handle (*Dart_LibraryTagHandler)(
    Dart_LibraryTag tag, Dart_Handle library_or_package_map_url,
    Dart_Handle url);
 ...
 */
DART_EXPORT DART_WARN_UNUSED_RESULT Dart_Handle Dart_DeferredLoadComplete(
    intptr_t loading_unit_id, const uint8_t* snapshot_data,
 ...
 * invocation of the Dart_DeferredLoadHandler.
 */
DART_EXPORT DART_WARN_UNUSED_RESULT Dart_Handle Dart_DeferredLoadCompleteError(
    intptr_t loading_unit_id, const char* error_message, bool transient);
 ...
 *   Otherwise an error handle is returned.
 */
DART_EXPORT Dart_Handle Dart_GetNonNullableType(
    Dart_Handle library, Dart_Handle class_name,
 ...
 */
DART_EXPORT DART_WARN_UNUSED_RESULT Dart_Handle Dart_LoadLibraryFromKernel(
    const uint8_t* kernel_buffer, intptr_t kernel_buffer_size);
...
DART_EXPORT Dart_KernelCompilationResult Dart_CompileToKernel(
    const char* script_uri, const uint8_t* platform_kernel,
    const intptr_t platform_kernel_size, bool incremental_compile,
    bool snapshot_compile, const char* package_config,
...
Dart_CompileToKernelWithGivenNullsafety(
    const char* script_uri, const uint8_t* platform_kernel,
    const intptr_t platform_kernel_size, bool snapshot_compile,
    const char* package_config, const bool null_safety,
    Dart_KernelCompilationVerbosityLevel verbosity);
...
DART_EXPORT void Dart_SetDartLibrarySourcesKernel(
    const uint8_t* platform_kernel, const intptr_t platform_kernel_size);
...
typedef void (*Dart_CreateLoadingUnitCallback)(
    void* callback_data, intptr_t loading_unit_id, void** write_callback_data,
...
Dart_CreateAppAOTSnapshotAsAssemblies(
    Dart_CreateLoadingUnitCallback next_callback, void* next_callback_data,
    bool stripped, Dart_StreamingWriteCallback write_callback,
 ...
 * \return A valid handle if no error occurs during the operation.
 */
DART_EXPORT DART_WARN_UNUSED_RESULT Dart_Handle Dart_CreateAppAOTSnapshotAsElf(
    Dart_StreamingWriteCallback callback, void* callback_data, bool stripped,
    void* debug_callback_data);
DART_EXPORT DART_WARN_UNUSED_RESULT Dart_Handle Dart_CreateAppAOTSnapshotAsElfs(
    Dart_CreateLoadingUnitCallback next_callback, void* next_callback_data,
    bool stripped, Dart_StreamingWriteCallback write_callback,
    Dart_StreamingCloseCallback close_callback);
