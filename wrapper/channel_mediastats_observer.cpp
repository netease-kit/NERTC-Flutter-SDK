...
void NERtcChannelWrapper::onRtcStats(const NERtcStats& stats) {
  Dart_CObject dart_object;
  dart_object.type = Dart_CObject_kString;

  json result;
  result["channel_tag"] = channel_tag_;
...
void NERtcChannelWrapper::onLocalAudioStats(const NERtcAudioSendStats& stats) {
  Dart_CObject dart_object;
  dart_object.type = Dart_CObject_kString;
...
void NERtcChannelWrapper::onRemoteAudioStats(const NERtcAudioRecvStats* stats,
...
void NERtcChannelWrapper::onLocalVideoStats(const NERtcVideoSendStats& stats) {
  Dart_CObject dart_object;
  dart_object.type = Dart_CObject_kString;
...
void NERtcChannelWrapper::onRemoteVideoStats(const NERtcVideoRecvStats* stats,
                                             unsigned int user_count) {
  Dart_CObject dart_object;
  dart_object.type = Dart_CObject_kString;
...
void NERtcChannelWrapper::onNetworkQuality(const NERtcNetworkQualityInfo* infos,
                                           unsigned int user_count) {
  Dart_CObject dart_object;
  dart_object.type = Dart_CObject_kString;
